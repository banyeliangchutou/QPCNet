...
with open("epoch_prf_log_mnist.txt", "w") as f:
...
for epoch in range(num_epochs):
    ...
    with open("epoch_prf_log_mnist.txt", "a") as f:
...
# plt.tight_layout()
# plt.savefig("training_results_mnist.png")
...
# np.savetxt("train_losses_mnist.txt", np.array(train_losses), fmt="%.6f")
# np.savetxt("test_accuracies_mnist.txt", np.array(test_accuracies), fmt="%.2f")
